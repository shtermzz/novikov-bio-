...
<head>
    ...
    <style>
        * {
        ...
        body {
            min-height: 100vh;
            background: linear-gradient(135deg, #0a0a0a, #1a1a1a, #2a2a2a, #0d0d0d);
        ...
        .scan-line {
            ...
            width: 100%;
            height: 4px;
            background: linear-gradient(90deg, transparent, #888888, #cccccc, #888888, transparent);
            opacity: 0.3;
        ...
        /* Основний термінальний контейнер */
        .terminal {
            position: relative;
            z-index: 10;
            width: 900px;
            ...
            box-shadow: 0 0 30px rgba(100, 100, 100, 0.2), 0 0 10px rgba(150, 150, 150, 0.2);
            overflow: hidden;
            transition: all 0.3s;
        }
        ...
        /* Бургер-кнопка (тільки на мобільних) */
        .burger-btn {
            display: none;
        ...
        /* Основний контент (двоколонкова сітка) */
        .terminal-body {
            display: flex;
            flex-wrap: wrap;
            min-height: 480px;
        ...
        /* Мобільне меню (бургер) - виїжджає зліва */
        .mobile-menu {
            position: fixed;
            top: 0;
            left: -280px;
        ...
        .mobile-menu .mobile-menu-item.active {
            background: linear-gradient(90deg, rgba(255, 77, 184, 0.3), transparent);
        ...
        .menu-item.active {
            background: linear-gradient(90deg, rgba(150, 150, 150, 0.2), transparent);
            border-left-color: #ff4db8;
            color: #fff;
        ...
        .content-title {
            ...
            margin-bottom: 20px;
            letter-spacing: 1px;
            border-bottom: 1px dashed #ff4db8;
            display: inline-block;
            padding-bottom: 5px;
        ...
        .cyber-btn {
            display: inline-block;
            background: linear-gradient(135deg, #ff4db8, #cc0080);
            padding: 10px 22px;
            border-radius: 30px;
            color: white;
            ...
            font-family: monospace;
            font-size: 0.9rem;
            box-shadow: 0 0 12px #ff4db8;
        }

        .cyber-btn:hover {
            transform: scale(1.02);
            box-shadow: 0 0 22px #ff4db8;
        }
        ...
        /* адаптивність — бургер режим */
        @media (max-width: 680px) {
            .burger-btn {
                display: flex;
            }
            .menu-panel {
                display: none; /* ховаємо звичайне меню на мобільних */
            }
            .content-panel {
                width: 100%;
            }
...
<div class="terminal">
    <div class="terminal-header">
        ...
        <div class="system-status">
            <span class="status-led"></span> STATUS: ONLINE
        </div>
    </div>

    <div class="terminal-body">
        <!-- Десктопна ліва панель -->
        <div class="menu-panel" id="desktopMenu">
            <div class="menu-item active" data-section="bio">
                <span class="menu-icon">👤</span>
                <span>BIO / WHOAMI</span>
            </div>
            <div class="menu-item" data-section="projects">
                <span class="menu-icon">💻</span>
                <span>PROJECTS / SKILLS</span>
            </div>
            <div class="menu-item" data-section="buy">
                <span class="menu-icon">💰</span>
        ...
        <div class="content-panel" id="dynamicContent">
            <div class="content-title" id="contentTitle">> WHOAMI.EXE</div>
            <div class="content-text" id="contentText">
                Занимаюсь трейдингом и программированием.<br>
                Анализирую финансовые рынки, создаю торговые стратегии.<br>
                Разрабатываю веб-проекты и автоматизирую процессы.<br>
                Живу в Восточной Европе → цель: финансовая независимость.<br>
                🔥 Технологии: JS, Python, React, Node.js, Web3.
            </div>
...
<div class="mobile-menu" id="mobileMenu">
    <div class="mobile-menu-item active" data-section="bio">
        <span class="menu-icon">👤</span>
        <span>BIO / WHOAMI</span>
    </div>
    ...
    <div class="mobile-menu-item" data-section="buy">
        <span class="menu-icon">💰</span>
        <span>BUY / OFFERS</span>
    </div>
    <div class="mobile-menu-item" data-section="contact">
        <span class="menu-icon">📩</span>
        <span>CONTACT / SOCIAL</span>
    </div>
</div>
